...
1. [Border radius mdn](https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius#Summary)
1. [Border radius CSS Reference](http://tympanus.net/codrops/css_reference/border-radius/)
1. [Text indent CSS reference](http://tympanus.net/codrops/css_reference/text-indent/)
1. [trying to align html button at the center of the my page](http://stackoverflow.com/questions/11799159/trying-to-align-html-button-at-the-center-of-the-my-page)
1. [How to get box-shadow on left & right sides only](http://stackoverflow.com/questions/11997032/how-to-get-box-shadow-on-left-right-sides-only)
